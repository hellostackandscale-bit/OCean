    ...
    <>
      ...
      <section className="section pt-6 pb-24 sm:pb-20" style={{ background: "var(--color-bg-secondary)" }}>
        <div className="container">
          ...
          <div className="flex overflow-x-auto pb-4 gap-2 mb-10 sm:mb-12 justify-start sm:justify-center items-center pt-2">
          ...
          <div className="flex flex-col gap-8 sm:gap-12">
            {filteredServices.map((service, i) => (
              <motion.div
                ...
                className="bg-white rounded-2xl sm:rounded-3xl overflow-hidden shadow-[var(--shadow-sm)] hover:shadow-md transition-all duration-300 border border-[var(--color-border)] group"
              >
                <div className="p-5 sm:p-7 md:p-8 flex flex-col lg:flex-row gap-6 lg:gap-10">
                  ...
                  <div className="lg:w-7/12 flex flex-col justify-between space-y-4">
                    <div>
                      ...
                      <div className="flex items-start justify-between gap-3 mb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span
                              className="text-[10px] font-extrabold uppercase tracking-wider px-2 py-0.5 rounded bg-blue-50 text-[var(--color-primary)] inline-block mb-1"
                            >
                              {service.category}
                            </span>
                            <h2
                    ...
                    {/* Action Buttons Row */}
                    <div className="flex flex-col sm:flex-row items-center gap-3 pt-3 border-t border-[var(--color-border-light)]">
                      <Link
                        href={`/contact?service=${encodeURIComponent(service.title)}`}
                        className="btn btn-primary btn-lg w-full sm:w-auto text-xs sm:text-sm justify-center"
                      >
                      ...
                      <button
                        ...
                        className="btn btn-outline btn-lg w-full sm:w-auto text-xs sm:text-sm justify-center"
                      >
                  ...
                  <div
                    className="lg:w-5/12 p-4 sm:p-6 rounded-2xl flex flex-col justify-between"
                    style={{
                  ...
                  >
                    <div>
                      <div className="flex items-center justify-between mb-3 pb-2 border-b border-[var(--color-border-light)]">
                        <h4
                      ...
                      <ul className="space-y-2">
                        {service.features.map((feature, j) => (
                          <li key={j} className="flex items-start gap-2 text-xs sm:text-sm font-medium text-slate-700">
