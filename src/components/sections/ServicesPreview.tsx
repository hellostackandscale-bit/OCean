...
const services = [
  ...
  },
  {
    ...
    description: "Complete supply of hospital & ICU equipment — ECG machines, multi-para monitors, ventilators, infusion/syringe pumps, baby warmers, OT lights, pendants, and MGPS hardware.",
    fullDescription: "We serve all types of hospital equipment — certified stockist and supplier of complete hospital gas pipeline hardware, ICU critical care devices, surgical OT equipment, diagnostic machines, and hospital ward furniture across India. All equipment is certified for clinical precision, safety, and hospital compliance.",
    features: [
      "3-Channel & 12-Channel ECG Machines with Interpretation & Printing",
      ...
      "Single & Dual Arm Ceiling Surgical Pendants (Gas + Electrical Ports)",
      "LED Shadowless Surgical OT Lights (Single & Dual Dome)",
      "Manual & Automatic Gas Manifold Control Panels with Digital Display",
      "Medical Gas Outlets (BS 5682 / DIN 13260 / AFNOR / Ohmeda Outlets)",
      "BPC Oxygen Flow Meters, Anodized Regulators & Vacuum Suction Units",
      "ICU Patient Beds, Bed Head Panels & Oxygen Cylinder Trolleys"
    ],
    tags: ["ICU & ECG Machines", "Ventilators & Pumps", "Baby Care & OT Lights", "MGPS Hardware"],
    badge: "02",
  },
  {
    id: "lpg-gas-piping",
